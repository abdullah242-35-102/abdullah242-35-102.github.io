...
async function initAccountPage() {
  ...
  const renderTab = async (tab) => {
    ...
    if (tab === 'addresses') content.innerHTML = '<div class="empty-state"><h2>No saved addresses yet</h2><p>Saved addresses can be added later if you connect a real backend or authentication service.</p></div>';
